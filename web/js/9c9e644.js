 ...
 */
(function() {var e=void 0,g=!0,h=null,k=!1;function m(a){return function(){return this[a]}}var n,p=this;function q(a,b,c){a=a.split(".");c=c||p;!(a[0]in c)&&c.execScript&&c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&b!==e?c[d]=b:c=c[d]?c[d]:c[d]={}}
...
function y(a,b,c){if(!a)throw Error();if(2<arguments.length){var d=Array.prototype.slice.call(arguments,2);return function(){var c=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(c,d);return a.apply(b,c)}}return function(){return a.apply(b,arguments)}}function z(a,b,c){z=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?x:y;return z.apply(h,arguments)}function A(a,b){q(a,b,e)};var B=/&/g,C=/</g,D=/>/g,E=/\"/g,F=/[&<>\"]/,G={"\x00":"\\0","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\"},H={"'":"\\'"};function I(a,b){a!=h&&this.append.apply(this,arguments)}I.prototype.b="";I.prototype.append=function(a,b,c){this.b+=a;if(b!=h)for(var d=1;d<arguments.length;d++)this.b+=arguments[d];return this};I.prototype.toString=m("b");function J(a,b,c){for(var d in a)b.call(c,a[d],d,a)}var K="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function L(a,b){for(var c,d,f=1;f<arguments.length;f++){d=arguments[f];for(c in d)a[c]=d[c];for(var i=0;i<K.length;i++)c=K[i],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}};var M=Array.prototype,N=M.indexOf?function(a,b,c){return M.indexOf.call(a,b,c)}:function(a,b,c){c=c==h?0:0>c?Math.max(0,a.length+c):c;if(t(a))return!t(b)||1!=b.length?-1:a.indexOf(b,c);for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},O=M.forEach?function(a,b,c){M.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=t(a)?a.split(""):a,i=0;i<d;i++)i in f&&b.call(c,f[i],i,a)};var P=z,v="twig_ui_"+Math.floor(2147483648*Math.random()).toString(36);function Q(a){return h===a||k===a||e===a||0===a?g:R(a)?0===S(a):k}function T(a,b){L.apply(h,Array.prototype.slice.call(arguments,0));return a}function R(a){return s(a)||t(a)||u(a)}function S(a){if(s(a))return a.length;if(t(a))return a.length;if(u(a)){var b=0,c;for(c in a)b++;return b}throw Error(typeof a+" is not countable.");}function U(a,b,c){s(a)?O(a,b,c):J(a,b,c)};function V(a){this.env_=a;this.c=[];this.l={}}n=V.prototype;n.s=m("c");n.C=function(a){this.c=a};n.I=function(a){this.l=a};n.getParent=function(a){a=this.getParent_(a);return k===a?k:this.env_.d(a)};n.B=function(a,b,c){if(a in this.l){var d=new I;this.l[a](d,b,c||{});return d.toString()}d=this.getParent(b);if(k!==d)return d.j(a,b,c);throw Error("The template '"+this.n()+"' has no parent, and no trait defining the block '"+a+"'.");};
n.j=function(a,b,c){if(c&&a in c){var d=new I,f=c[a];delete c[a];f(d,b,c);return d.toString()}if(a in this.c)return d=new I,this.c[a](d,b,c||h),d.toString();d=this.getParent(b);return k!==d?d.j(a,b,c):""};n.i=function(a,b){var c=new I;this.render_(c,a||{},b||{});return c.toString()};
n.q=function(a,b,c,d){if(!a["get"+b])throw Error("The macro "+b+" is not defined in "+a.n()+".");if(d===e)return a["get"+b].apply(a,c);throw Error("Positional arguments, or default values in macro arguments are not supported, yet.");};function W(){this.a={};this.f={};this.g={};this.k={};this.e={};this.o={};this.p=k;this.J="UTF-8"}n=W.prototype;n.i=function(a,b){var c=this.d(a);return c.i.call(c,T({},this.o,b||{}))};n.filter=function(a,b,c){if(!(a in this.f))throw Error("The filter '"+a+"' does not exist.");return this.f[a].apply(h,Array.prototype.slice.call(arguments,1))};n.w=function(a,b,c){if(!(a in this.g))throw Error("The function '"+a+"' does not exist.");return this.g[a].apply(h,Array.prototype.slice.call(arguments,1))};
n.test=function(a,b,c){if(!(a in this.k))throw Error("The test '"+a+"' does not exist.");return this.k[a].apply(h,Array.prototype.slice.call(arguments,1))};n.z=function(a,b,c){var d=this.d(a),f=d["get"+b];if(!f)throw Error("The macro '"+b+"' does not exist on template '"+d.n()+"'.");return f.apply(d,Array.prototype.slice.call(arguments,2)).toString()};n.F=function(a,b){this.f[a]=b};n.G=function(a,b){this.g[a]=b};n.H=function(a,b){this.k[a]=b};n.u=m("o");
n.h=function(){this.p=g;J(this.a,function(a){a.h()},this)};n.v=function(a){return a in this.a};n.getExtension=function(a){if(!(a in this.a))throw Error('The "'+a+'" extension is not enabled.');return this.a[a]};n.m=function(a){this.a[a.getName()]=a};n.A=function(a){delete this.a[a]};n.D=function(a){J(a,function(a){this.m(a)})};n.t=m("a");n.d=function(a){var b=a[v]||(a[v]=++w);if(b in this.e)return this.e[b];k===this.p&&this.h();a=new a(this);return this.e[b]=a};function X(a){this.r=a}X.prototype.toString=m("r");window.Twig=new W;A("goog.provide",function(a){q(a)});A("goog.require",function(){});
A("twig.attr",function(a,b,c,d,f){d=d||"any";f=f!==e?f:k;if(!u(a)&&!s(a))return f?k:h;if(b in a){if("array"!==d&&"function"==r(a[b]))return f?g:a[b].apply(a,c||[]);if("method"!==d)return f?g:a[b]}if("array"===d||s(a))return f?k:h;var b=b.toLowerCase(),i="get"+b,l="is"+b,j;a:{b=function(a,b){b=b.toLowerCase();return b===i||b===l};for(j in a)if(b.call(e,0,j))break a;j=e}return j&&"function"==r(a[j])?f?g:a[j].apply(a,c||[]):f?k:h});A("twig.bind",P);
A("twig.inherits",function(a,b){function c(){}c.prototype=b.prototype;a.K=b.prototype;a.prototype=new c});A("twig.extend",T);A("twig.spaceless",function(a){return a.replace(/>[\s\xa0]+</g,"><").replace(/^[\s\xa0]+|[\s\xa0]+$/g,"")});A("twig.range",function(a,b){for(var c=[];a<=b;a+=1)c.push(a);return c});A("twig.contains",function(a,b){var c;if(s(a))c=0<=N(a,b);else if(t(a))c=-1!=a.indexOf(b);else a:{for(c in a)if(a[c]==b){c=g;break a}c=k}return c});A("twig.countable",R);A("twig.count",S);
A("twig.forEach",U);A("twig.empty",Q);A("twig.createObj",function(a){for(var b={},c=0;c<arguments.length;c+=2)b[arguments[c]]=arguments[c+1];return b});A("twig.filter.capitalize",function(a,b){return b.charAt(0).toUpperCase()+b.substring(1)});
A("twig.filter.escape",function(a,b,c,d,f){if(f&&b instanceof X)return b.toString();b=b==h?"":String(b);if("js"===c){a=String(b);if(a.quote)b=a.quote();else{b=['"'];for(c=0;c<a.length;c++){var i=a.charAt(c),l=i.charCodeAt(0),d=b,f=c+1,j;if(!(j=G[i])){if(!(31<l&&127>l))if(i in H)i=H[i];else if(i in G)i=H[i]=G[i];else{l=i;j=i.charCodeAt(0);if(31<j&&127>j)l=i;else{if(256>j){if(l="\\x",16>j||256<j)l+="0"}else l="\\u",4096>j&&(l+="0");l+=j.toString(16).toUpperCase()}i=H[i]=l}j=i}d[f]=j}b.push('"');b=b.join("")}return b.substring(1,
b.length-1)}if(!c||"html"===c)return a=b,F.test(a)&&(-1!=a.indexOf("&")&&(a=a.replace(B,"&amp;")),-1!=a.indexOf("<")&&(a=a.replace(C,"&lt;")),-1!=a.indexOf(">")&&(a=a.replace(D,"&gt;")),-1!=a.indexOf('"')&&(a=a.replace(E,"&quot;"))),a;if("url"===c)return encodeURIComponent(b);throw Error("The type '"+c+"' is not supported.");});A("twig.filter.length",function(a,b){return S(b)});A("twig.filter.def",function(a,b){return Q(a)?b||"":a});
A("twig.filter.replace",function(a,b){for(var c in b)a=a.replace(RegExp(c,"g"),b[c]);return a});A("twig.filter.join",function(a,b){var c=b||"",d=new I,f=g;U(a,function(a){f||d.append(c);f=k;d.append(a)});return d.toString()});A("twig.filter.keys",function(a){var b=[],c=0,d;for(d in a)b[c++]=d;return b});A("twig.filter.upper",function(a,b){return b.toUpperCase()});A("twig.filter.lower",function(a,b){return b.toLowerCase()});A("twig.filter.nl2br",function(a){return a.replace(/\n/g,"<br />")});
A("twig.StringBuffer",I);I.prototype.append=I.prototype.append;I.prototype.toString=I.prototype.toString;W.prototype.createTemplate=W.prototype.d;W.prototype.filter=W.prototype.filter;W.prototype.invoke=W.prototype.w;W.prototype.test=W.prototype.test;W.prototype.macro=W.prototype.z;W.prototype.setFilter=W.prototype.F;W.prototype.setFunction=W.prototype.G;W.prototype.setTest=W.prototype.H;W.prototype.render=W.prototype.i;W.prototype.getGlobals=W.prototype.u;W.prototype.initRuntime=W.prototype.h;
W.prototype.hasExtension=W.prototype.v;W.prototype.getExtension=W.prototype.getExtension;W.prototype.addExtension=W.prototype.m;W.prototype.removeExtension=W.prototype.A;W.prototype.setExtensions=W.prototype.D;W.prototype.getExtensions=W.prototype.t;A("twig.Template",V);V.prototype.setTraits=V.prototype.I;V.prototype.setBlocks=V.prototype.C;V.prototype.getBlocks=V.prototype.s;V.prototype.renderParentBlock=V.prototype.B;V.prototype.renderBlock=V.prototype.j;V.prototype.callMacro=V.prototype.q;
A("twig.Markup",X);})();
